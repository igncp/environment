...
use super::{install_nvim_package, lua::setup_nvim_lua};
...
"###,
    ...
    if !Path::new(
        &context
            .system
            .get_home_path("development/environment/project/.vim-custom.lua"),
    )
    .exists()
    {
        System::run_bash_command("touch ~/development/environment/project/.vim-custom.lua");
    }
