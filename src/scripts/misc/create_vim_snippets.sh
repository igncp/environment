...
alias ModifySnippets='"$EDITOR" ~/development/environment/src/scripts/misc/create_vim_snippets.sh && sh ~/development/environment/src/scripts/misc/create_vim_snippets.sh'
EOF
